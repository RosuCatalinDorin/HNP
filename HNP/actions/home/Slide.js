document.addEventListener("DOMContentLoaded", function () {
  let data = [
    {
      img:
        "https://www.hnp.ro/wp-content/uploads/2020/08/W_T_Turning_Perform_1920-1080_RO-900x500.jpg",
      titleWithe: "Gama",
    ...
    },
    {
      id: 2,
      img:
        "https://www.hnp.ro/wp-content/uploads/2020/08/W_All_Perform_1920-1080_RO-900x500.jpg",
    ...
    },
    {
      id: 3,
      img:
        "https://www.hnp.ro/wp-content/uploads/2020/06/promotie1_smicat_HNP-e1597263209992-900x500.png",
      titleWithe: "Building Up",
      titleYellow: "Vision,<br/>  Leading Future",
      description:
        "We offer the most complete industrial solutions in the country, for the research, design and development of materials.",
  ...
  data.forEach(function (data) {
    startSlide +=
      '<div class="item home-slider-bg" id="imgSlide-' + data.id + '">';
    ...
    startSlide +=
      ...
      "</span> </h1>";
    startSlide +=
      '          <h5 class="slider-sub-heading">' + data.description + " </h5>";
    startSlide +=
